...
const SKELETON_COLORS: Record<"light" | "dark", SkeletonThemeProps> = {
	light: {
		...
		baseColor: "hsl(40, 13%, 92%)", 
		highlightColor: "hsl(40, 13%, 97%)", 
	},
	dark: {
		// Colores coordinados con --color-green-dark-800 y --color-green-dark-700
		baseColor: "hsl(150, 10%, 20%)", 
		highlightColor: "hsl(150, 10%, 25%)", 
	},
};
...
export const useSkeletonTheme = (): SkeletonThemeProps => {
	...
	// se retorna el tema 'light' por defecto para evitar errores en tiempo de ejecución.
